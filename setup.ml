...
(* OASIS_START *)
(* DO NOT EDIT (digest: 343728ea91fd14db58666109d8dbfba1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               ...
               "(C) 2000-2013 Markus Mottl <markus.mottl@gmail.com>";
               "(C) 2000-2012 Liam Stewart <liam@cs.toronto.edu>";
               "(C) 2000-2013 Christophe Troestler <Christophe.Troestler@umons.ac.be>";
          ...
          homepage = Some "https://bitbucket.org/mmottl/lacaml";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/lacaml";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\239b\225\226\151\216\255f\000Z\004\190'A\n\215";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
