...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8b2cfbf96b1f9c9a95724f98aa9e4f4b) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ÑBG\150wº\024¦©\136à­Ðä\142õ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
let () =
  ...
  let src =
    if ocaml_major > 4 || (ocaml_major = 4 && ocaml_minor >= 2) then
      "lib/lacaml_compat402.ml"
    else
      "lib/lacaml_compat312.ml"
  in
  cp_file src "lib/lacaml_compat.ml"
