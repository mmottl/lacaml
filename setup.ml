...
(* OASIS_START *)
(* DO NOT EDIT (digest: 791b9aeaa7587c598c2831453646c0f3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               ...
               "(C) 2000-2015 Markus Mottl <markus.mottl@gmail.com>";
          ...
          files_ab = ["lib/lacaml_version.ml.ab"];
          sections =
            [
               Flag
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¾©\028ü\028Î\151\133káFKÍ\006þ\138";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
