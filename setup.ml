...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8cc70ce0314352348e205912632318a5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2000-2012 Egbert Ammicht <eammicht@lucent.com>";
               "(C) 2000-2012 Patrick Cousot <Patrick.Cousot@ens.fr>";
               "(C) 2000-2012 Jane Street Capital LLC <opensource@janestreet.com>";
               "(C) 2000-2017 Markus Mottl <markus.mottl@gmail.com>";
               "(C) 2000-2012 Liam Stewart <liam@cs.toronto.edu>";
               "(C) 2000-2017 Christophe Troestler <Christophe.Troestler@umons.ac.be>";
          ...
          homepage = Some "http://mmottl.github.io/lacaml";
          bugreports = None;
          ...
          tags = [];
          categories = [];
          files_ab = ["src/lacaml_version.ml.ab"];
          sections =
            [
               Flag
                 ({
                      ...
                      bs_ccopt =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.ETest ("system", "freebsd"),
                                OASISExpr.ETest ("system", "macosx")),
                             ["-DEXTERNAL_EXP10"; "-DEXTERNAL_EXP10"]);
                           (OASISExpr.EAnd
                              (OASISExpr.EAnd
                                 (OASISExpr.ETest ("system", "freebsd"),
                                   OASISExpr.ETest ("system", "macosx")),
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "nag_gbsv.ml"});
               Executable
                 ({
                     cs_name = "nag_gesv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_gesv.ml"});
               Executable
                 ({
                     cs_name = "nag_gtsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_gtsv.ml"});
               Executable
                 ({
                     cs_name = "nag_pbsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_pbsv.ml"});
               Executable
                 ({
                     cs_name = "nag_posv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_posv.ml"});
               Executable
                 ({
                     cs_name = "nag_ppsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_ppsv.ml"});
               Executable
                 ({
                     cs_name = "nag_ptsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_ptsv.ml"});
               Executable
                 ({
                     cs_name = "nag_spsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_spsv.ml"});
               Executable
                 ({
                     cs_name = "nag_sysv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "nag_sysv.ml"});
               Executable
                 ({
                     cs_name = "schur_real";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "schur_real.ml"});
               Executable
                 ({
                     cs_name = "schur_complex";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mmottl/lacaml.git";
                      src_repo_browser =
                        Some "https://github.com/mmottl/lacaml";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\252|\177(k\191\020\224\141\004\188Z\199h\199\251";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
