...
(** [pocon ?n ?up ?anorm ?work ?rwork ?ar ?ac a]
    @return
      estimate of the reciprocal of the condition number of complex Hermitian
...
val geev_opt_lwork :
  ...
  mat ->
  int
(** [geev ?work ?rwork ?n ?vlr ?vlc ?vl ?vrr ?vrc ?vr ?ofsw w ?ar ?ac a] See
    [geev]-function for details about arguments.
...
(** [geev ?work ?rwork ?n ?vlr ?vlc ?vl ?vrr ?vrc ?vr ?ofsw w ?ar ?ac a]
    @return
      ...
      empty matrix if [vl] ([vr]) is set to [None].
