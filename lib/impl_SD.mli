...
val sygv_opt_lwork :
  ...
  mat
  -> int
  (** [syev_opt_lwork ?n ?vectors ?up ?ar ?ac a ?br ?bc b] @return the
      optimum length of the work-array used by the [sygv]-function for
      the given matrices [a] and [b], optionally their logical dimension
      [n] and whether the eigenvectors must be computed ([vectors]).
